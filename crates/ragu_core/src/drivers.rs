...
/// Defines implementation types for a concrete driver. This trait separates
/// type definitions from the [`Driver<'dr>`] lifetime, allowing types like
/// [`WireMap`](crate::convert::WireMap) to reference driver-associated types
/// without requiring a specific lifetime. Users of drivers do not need to
