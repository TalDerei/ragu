...
//! the `mock` feature to instead expose an API-level mock of
//! `ragu_pcd` (re-exported at the crate root), used to integrate downstream
//! consumers (e.g. Zebra) against the eventual interface ahead of the real
