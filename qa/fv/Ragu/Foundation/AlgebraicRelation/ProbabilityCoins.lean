...
/-!
Ported from `Zcash/Common/RelationProbabilityCoins.lean` at `zcash/ironwood` commit
`3c056cbebf2880b54f801c348cb67ce7dc9f2a05`. Ragu adapts the namespace and internal import.
-/
...
namespace Ragu.Foundation.AlgebraicRelation
...
end Ragu.Foundation.AlgebraicRelation
