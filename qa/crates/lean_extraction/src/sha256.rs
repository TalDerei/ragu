...
pub fn sha256(msg: &[u8]) -> [u8; 32] {
    // Pad: append 0x80, then zeros until the length is 56 mod 64, then the
...
mod tests {
    ...
    /// FIPS 180-2 test vectors, plus padding boundary cases.
    #[test]
    fn fips_test_vectors() {
        ...
        // One byte short of the padding boundary (55 bytes).
        assert_eq!(
            hex(&sha256(&[b'a'; 55])),
